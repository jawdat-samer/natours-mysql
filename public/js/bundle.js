...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(oldPassword, newPassword, newPasswordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
var userUpdatePasswordForm = document.querySelector('.form-user-settings');
if (loginForm) {
...
if (userUpdatePasswordForm) {
  userUpdatePasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var oldPassword = document.querySelector('#password-current').value;
    var newPassword = document.querySelector('#password').value;
    var newPasswordConfirm = document.querySelector('#password-confirm').value;
    (0, _updateSettings.updatePassword)(oldPassword, newPassword, newPasswordConfirm);
  });
}
